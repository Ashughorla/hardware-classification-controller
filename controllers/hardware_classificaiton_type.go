	...
	host0 := bmh.BareMetalHost{
		...
		Status: bmh.BareMetalHostStatus{
			...
			HardwareDetails: &bmh.HardwareDetails{
				...
				NIC: []bmh.NIC{bmh.NIC{IP: "", MAC: "b8:59:9f:cf:fa:b3", Model: "0x15b3 0x1015", Name: "eth11", PXE: false, SpeedGbps: 0, VLANID: 0},
					bmh.NIC{IP: "192.168.121.96", MAC: "b8:59:9f:cf:fa:b2", Model: "0x15b3 0x1015", Name: "eth10", PXE: false, SpeedGbps: 0, VLANID: 0},
					bmh.NIC{IP: "192.168.121.65", MAC: "b8:59:9f:cf:fa:ba", Model: "0x15b3 0x1015", Name: "eth6", PXE: true, SpeedGbps: 0, VLANID: 0}},
				RAMMebibytes: 196608,
				Storage: []bmh.Storage{bmh.Storage{Name: "/dev/sda", SizeBytes: 599550590976},
	...
	host2 := bmh.BareMetalHost{
		...
		Status: bmh.BareMetalHostStatus{
			Provisioning: bmh.ProvisionStatus{
				...
				Hostname: "localhost.localdomain",
				NIC: []bmh.NIC{bmh.NIC{IP: "", MAC: "b8:59:9f:cf:fa:b3", Model: "0x15b3 0x1015", Name: "eth11", PXE: false, SpeedGbps: 0, VLANID: 0},
					bmh.NIC{IP: "", MAC: "b8:59:9f:cf:fa:b3", Model: "0x15b3 0x1015", Name: "eth10", PXE: false, SpeedGbps: 0, VLANID: 0},
					bmh.NIC{IP: "", MAC: "b8:59:9f:cf:fa:b3", Model: "0x15b3 0x1015", Name: "eth09", PXE: false, SpeedGbps: 0, VLANID: 0},
					bmh.NIC{IP: "192.168.121.65", MAC: "b8:59:9f:cf:fa:ba", Model: "0x15b3 0x1015", Name: "eth6", PXE: true, SpeedGbps: 0, VLANID: 0}},
				RAMMebibytes: 32,768‬,
				Storage: []bmh.Storage{bmh.Storage{Name: "/dev/sda", SizeBytes: 599550590976},
					bmh.Storage{Name: "/dev/sdb", SizeBytes: 599550590976},
